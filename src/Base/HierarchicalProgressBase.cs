...
#region Ctor
        ...
        protected HierarchicalProgressBase(Range<double> progressBoundaries, Range<double> reportBoundaries)
        {
...
#region Fields
        ...
        private Index<double> _progress;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private double _allocatedProgress;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private Range<double> _reportBoundaries;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private (ProgressChange Type, double Delta) _latestChange;
...
#region Properties
        ...
        public Range<double> ProgressBoundaries { get; }

        public Index<double> Progress
        {
            get => _progress;
        ...
        public Range<double> ReportBoundaries
        {
        ...
        public Range<double> OriginReportBoundaries { get; }
        ...
        public (ProgressChange Type, double Delta) LatestChange
        {
            get => _latestChange;
            protected set
            {
...
#region Public members
        ...
        /// </remarks>
        public IHierarchicalProgress<TProgressReport> Slice(double allocateProgress) => Slice(OriginReportBoundaries, allocateProgress);
        
        // Implement strongly typed. Use explicit implementation for the trade interface.
        /// <inheritdoc cref="IHierarchicalProgress{TProgressReport}.Slice(Range{double}, double)"/>
        public abstract HierarchicalProgress<TProgressReport> Slice(Range<double> reportBoundaries, double allocateProgress);
        
        IHierarchicalProgress<TProgressReport> IHierarchicalProgress<TProgressReport>.Slice(Range<double> reportBoundaries, double allocateProgress) => Slice(reportBoundaries, allocateProgress);
